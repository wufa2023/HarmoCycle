...
# 读取数据
res <- anndata::read_h5ad('/home/wenbaole/Cycle/regression/ref_dataset_Buettner.h5ad')
temp_matrix <- t(res$X)
...
save(seurat_obj, corrected_seurat, file = "/home/wenbaole/Cycle/res//CC_mESC_seurat_objects.rda")
