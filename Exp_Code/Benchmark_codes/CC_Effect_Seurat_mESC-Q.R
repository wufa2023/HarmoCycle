...
# 读取数据
res <- anndata::read_h5ad('/home/wenbaole/Cycle/regression/ref_dataset_Sasagawa.h5ad')
temp_matrix <- t(res$X)
...
save(seurat_obj, corrected_seurat, file = "/home/wenbaole/Cycle/res//CC_mECS-Q_seurat_objects.rda")
