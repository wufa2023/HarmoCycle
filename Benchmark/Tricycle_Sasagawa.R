...
res <- anndata::read_h5ad('/remote-home/share/data2/wbl/wbl_cellcycle/ground-truth/ref_dataset_Sasagawa.h5ad')
...
print(head(plot_df))
write.csv(plot_df, '/root/Cycle/HarmoCycle_v1/Result/Tricycle/Projection_Sasagawa.csv')
